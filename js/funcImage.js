...
function change() {
	xLeftValue = parseFloat(j("xLeftValue").value);
	xRightValue = parseFloat(j("xRightValue").value);
	yLeftValue = parseFloat(j("yLeftValue").value);
	yRightValue = parseFloat(j("yRightValue").value);
	reDraw();
}

function update() {
	j("xLeftValue").value = Math.round(xLeftValue*100)/100;
	j("xRightValue").value = Math.round(xRightValue*100)/100;
	j("yLeftValue").value = Math.round(yLeftValue*100)/100;
	j("yRightValue").value = Math.round(yRightValue*100)/100;
}
...
function Add() {
	var newInput = j("mod").cloneNode(true);
	newInput.style.display = "block";
	newInput.children[0].value = getRandomColor();
	j("function").appendChild(newInput);
}
